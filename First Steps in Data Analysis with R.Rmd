...
<!-- RStudio is an application that combines in one interface an editor for R programs, access to the R language interpreter, file, help and graphs browser and a history and data environment viewer. -->
